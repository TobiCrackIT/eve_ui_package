...
const Color kEveError=Color(0xFFA13226);
const Color kEveGreen=Color(0xff00FF00);
const Color kEveJacarta = Color(0xff3F3356);
const Color kEveRed=Color(0xffFF0000);
const Color kEveSolitude = Color(0xffE8EDFB);
const Color kEveSuccess = Color(0xFF43BF75);
const Color kEveViolentViolet = Color(0xff291D4A);
const Color kEveWhite=Color(0xffFFFFFF);
